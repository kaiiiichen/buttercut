...
<Step n={4} title="Pick a colour mood">
...
<Step n={5} title="Reorder or hide home blocks">
...
<Step n={6} title="Add or override a block">
...
<Step n={7} title="Write notes in .md or .mdx">
...
<Step n={8} title="Turn on optional integrations">
