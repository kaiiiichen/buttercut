interface ButtercutWeatherIllustrationProps {
  weatherCode: number;
  className?: string;
}
...
function getVariant(
  code: number,
): "sunny" | "partly-cloudy" | "overcast" | "rainy" | "thunderstorm" | "snowy" {
...
export function ButtercutWeatherIllustration({
  weatherCode,
  className,
}: ButtercutWeatherIllustrationProps) {
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {variant === "sunny" && <Sun cx={60} cy={40} r={16} />}
